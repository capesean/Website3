...
:: use this command to generate the .pem and .pfx files:
:: -- it will create the files for the project name as in the package.json file. this must match the values in the nr serve line below:
::npm run prestart
